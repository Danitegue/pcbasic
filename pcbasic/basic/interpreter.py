        ...
        while True:
            ...
            try:
                ...
                if c in tk.END_LINE:
                    ...
                    #codes = ['1258', '437', '720', '737', '775', '806', '850', '851', '852', '853', '855', '856', '857',
                    #         '858', '860', '861', '862', '863', '864', '865', '866', '868', '869', '874', '932', '934',
                    #         '936', '938', '949', '950', 'alternativnyj', 'armscii8a', 'big5-2003', 'big5-hkscs',
                    #         'georgian-academy', 'georgian-ps', 'iransystem', 'iscii-as', 'iscii-be', 'iscii-de',
                    #         'iscii-gu', 'iscii-ka', 'iscii-ma', 'iscii-or', 'iscii-pa', 'iscii-ta', 'iscii-te',
                    #         'kamenicky', 'koi8-r', 'koi8-ru', 'koi8-u', 'mazovia', 'mik', 'osnovnoj', 'pascii',
                    #         'ruscii', 'russup3', 'russup4ac', 'russup4na', 'viscii']
                    #for cod in codes:
                    #    try:
                    #         print token.decode(cod)
                    #    except:
                    #        pass
