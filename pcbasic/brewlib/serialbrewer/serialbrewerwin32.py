...
# On 20170806 - Somme changes added by Daniel Santana:
#renamed all self.is_open by self._isOpen
#renamed all self._rts_state by self._rtsState
...
class Serial(SerialBase):
    ...
    BAUDRATES = (9600, 1200, 2400, 4800)

    def __init__(self, *args, **kwargs):
        self._port_handle = None
        self._overlapped_read = None
        self._overlapped_write = None
        #self.verbose = config.get('use-serial-brewer-verbose')
    ...
    def open(self):
        ...
        # This has been replaced by these two lines in init
        #self._rtsState = win32.RTS_CONTROL_ENABLE
        #self._dtrState = win32.DTR_CONTROL_ENABLE

        # if RTS and/or DTR are not set before open, they default to True
        #if self._rtsState is None:
        #    self._rtsState = True
        #if self._dtrState is None:
        #    self._dtrState = True
