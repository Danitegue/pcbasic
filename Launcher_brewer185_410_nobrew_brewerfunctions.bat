...
%PYTHON_DIR%\python.exe %PCBASIC_PATH%\run.py --interface=ansi --mount=C:%MOUNT_C%,D:%MOUNT_D% --run=%PROGRAM% --quit=False -f=10 --shell="python Brewerfunctions.py" --scaling=smooth --logfile=%LOG_DIR%\pcbasic_brewer_log.txt
